  ...
  <div>
    ...
    <el-row :gutter="36">
      <el-col :span="6" v-for="item in chartList" :key="item._id">
        <el-card :body-style="{ padding: '0px' }" shadow="hover" @click.native="editChart(item._id)"><img class="image"
            :src="item.img" />
          <div style="padding: 14px;"><span>{{item.title}}</span>
            <el-dropdown style="float: right;"><i class="el-icon-more"></i>
              <el-dropdown-menu slot="dropdown">
                ...
                <el-dropdown-item @click.native="viewChart(item._id)" divided="divided">访问</el-dropdown-item>
