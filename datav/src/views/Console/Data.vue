  ...
  <div>
    ...
    <el-table :data="connectList">
      <el-table-column prop="_id" label="id">
        <template slot-scope="scope"><span>{{ scope.row._id | simplifyID }}</span></template>
      </el-table-column>
      <el-table-column prop="name" label="名称"></el-table-column>
      <el-table-column prop="createdAt" label="上传时间">
        <template
          slot-scope="scope"><span>{{ $dayjs(scope.row.createdAt).format('YYYY-MM-DD HH:mm') }}</span></template>
      </el-table-column>
