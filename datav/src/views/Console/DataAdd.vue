      ...
      <el-col :span="12">
        <el-form :model="form" :rules="rules" ref="ruleForm" label-width="100px" :hide-required-asterisk="true">
          ...
          <el-form-item label="数据文件">
            <el-upload class="upload" ref="fileUpload" drag="drag" action="/" :on-change="importExcel"
              :on-exceed="onFileExceed" :on-remove="onFileRemove" :auto-upload="false" :limit="1"><i
          ...
          <el-form-item label="选择指标" prop="metrics">
            <el-checkbox-group v-model="form.metrics">
              <el-checkbox v-for="item in form.columnsRaw" :label="item" :disabled="item == form.dimension" :key="item">
              </el-checkbox>
            </el-checkbox-group>
          </el-form-item>
          <el-form-item>
